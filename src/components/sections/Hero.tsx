				...
				<div className='grid lg:grid-cols-2 gap-12 lg:gap-16 items-center'>
					<div className='text-center lg:text-left'>
						...
						<p className='text-lg md:text-xl text-muted-foreground mb-8 max-w-xl mx-auto lg:mx-0'>
							We design and build fast, conversion-focused
							websites that match the quality of your work —
							optimized to perform from the first visit to the
							first sale.
						</p>
					...
					<div className='relative'>
						...
						<div
							className='absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 animate-bounce'
							aria-hidden='true'>
							<button
