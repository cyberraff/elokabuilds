...
const caseStudies = [
  {
    ...
    problem: "Slow, outdated site that didn't work on mobile. Potential clients couldn't contact them easily.",
    solution: "Rebuilt with Next.js — fast, accessible, mobile-first. Added clear CTAs, contact forms, and practice area pages.",
    outcome: "PageSpeed 94/100. 40% more contact form submissions in first month.",
    thumbnail: "/images/case-law-firm.jpg",
  ...
  },
  {
    ...
    problem: "Booking flow was broken on mobile. Images unoptimized. No clear value proposition.",
    solution: "Redesigned with focus on visual storytelling. Integrated booking engine. Optimized all assets.",
    outcome: "Mobile conversions up 60%. PageSpeed from 32 to 91.",
    thumbnail: "/images/case-hotel.jpg",
  ...
  },
  {
    ...
    category: "Healthcare",
    problem: "Patients couldn't book appointments online. Site loaded in 8+ seconds. Not HIPAA-aware.",
    solution: "Built patient portal with appointment scheduling. Optimized for Core Web Vitals. Added privacy-first forms.",
    outcome: "Online bookings increased 3x. Load time under 2s.",
    thumbnail: "/images/case-clinic.jpg",
  ...
  },
  {
    ...
    category: "Retail",
    problem: "WooCommerce site crashing under traffic. Cart abandonment at 85%. No analytics.",
    solution: "Migrated to Next.js + Shopify headless. Added proper tracking. Optimized checkout flow.",
    outcome: "Revenue up 120% YoY. Zero downtime during peak seasons.",
    thumbnail: "/images/case-retail.jpg",
  ...
  },
  {
    ...
    category: "Education",
    problem: "Custom PHP platform unmaintainable. Video playback broken on mobile. No student dashboard.",
    solution: "Rebuilt with Next.js. Integrated Mux for video. Built student progress tracking.",
    outcome: "Course completion rate up 45%. Mobile engagement doubled.",
    thumbnail: "/images/case-education.jpg",
  ...
  },
  {
    ...
    problem: "No portfolio of past work. Contact form broken. Not ranking locally.",
    solution: "Built project showcase with filtering. Fixed forms. Added local SEO schema and location pages.",
    outcome: "Organic leads up 200%. 15+ qualified quotes/month.",
    thumbnail: "/images/case-construction.jpg",
  ...
  return (
    <Section id="work" size="lg" aria-labelledby="work-heading">
      <div className="text-center max-w-3xl mx-auto mb-16">
        <h2 id="work-heading" className="text-3xl md:text-4xl font-bold tracking-tight mb-4">
          Selected Work
        </h2>
        <p className="text-lg text-muted-foreground">
          Real projects, real results. Placeholder data from past portfolio —
          will be replaced with Silent Contractor client work as deals close.
        </p>
      </div>

      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {caseStudies.map((project) => (
          <Card key={project.slug} className="group overflow-hidden flex flex-col">
            <div className="relative aspect-video overflow-hidden bg-muted">
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-muted-foreground text-sm">Project Thumbnail</span>
              </div>
      ...
      <div className="mt-12 text-center">
        <p className="text-muted-foreground mb-4">
          More case studies coming as Silent Contractor clients launch.
        </p>
        <a
          href="#contact"
